        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-4 col-md-6">
              <a href="index-2.html" className="d-flex ">
            ...
            <div className="col-lg-2 col-md-6">
              ...
              <a className="btn btn-link" href="index-2.html">
                Home
              </a>
              <a className="btn btn-link" href="about.html">
                About Us
              </a>
              <a className="btn btn-link" href="team.html">
                Our Team
              </a>
              <a className="btn btn-link" href="services.html">
                Services
              </a>
          ...
          <div className="copyright">
            <div className="row">
              <div className="col text-center text-md-start mb-3 mb-md-0">
                &copy; Copyright 2024 |{" "}
                <a className="border-bottom" href="index-2.html">
                  ProfitPuls
                </a>{" "}
                | All Right Reserved.
              </div>
